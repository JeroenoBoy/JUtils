...
namespace JUtils.Editor
{
    ...
    public class MinMaxIntEditor : PropertyDrawer
    {
        ...
        {
            SerializedProperty minField = property.FindPropertyRelative(nameof(MinMaxInt._min));
            SerializedProperty maxField = property.FindPropertyRelative(nameof(MinMaxInt._max));
